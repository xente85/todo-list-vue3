<template>
  ...
  <div v-show="list.length > 0" class="main">
    <input class="toggle-all edit" type="checkbox" id="toggleAll">
    <label for="toggleAll"></label>
    <TransitionGroup class="todo-list" name="list" tag="ul">
      <bItem v-for="item in list" :key="item.id" :item="item" />
    </TransitionGroup>
  </div>
...
import bItem from '../base/b-item.vue'
...
const itemsLeft = computed(() => props.list.filter(x => !x.completed).length)
</script>
